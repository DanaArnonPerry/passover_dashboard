...
<h4 style="margin-top: 20px; color: #3366cc;">יוצרי הדשבורד</h4>

<p><b>על הרעיון:</b> Dana Arnon Perry – מלמדת אוריינות נתונים, קוסמת של אינסייטים ומי שאחראית לכך שפסח השנה קיבל גרסת BI עם AI 😎</p>
...
<p><b>לפרטים נוספים וקישור להורדת הקוד, גללו ללשונית "👥 על היוצרים"</p>
</div> 
        </div>
