    ...
    <div class="welcome-header">
        <div class="welcome-title-container">
            ...
            <div class="github-info">
                <p>יוצרי הדשבורד</p>
                <p>הרעיון: Dana Arnon Perry</b> -מלמדת אוריינות נתונים, קוסמת של אינסייטים ומי שאחראית לכך שפסח השנה קיבל גרסת BI 😎"</p>
                <p>המוציא לפועל: ChatGPT</b> - רובוט צייתן עם חוש הומור בריא ואובססיה לדאטה סטים מוזרים מתקופת המקרא"</p>
                <p>דאטה סטוריטלר: Claude</b> - דאטה סטוריטלר: Claude – אחראי על שדרוג הקוד והמראה של הדשבורד ותכל'ס הייתי צריך לעשות את רוב העבודה בסוף (רק אומר)"</p>          
  ...
  with col1:
    ...
    with col2:
        ...
        <div class="feature-card">
            <h3>יוצרי הדשבורד</h3>
            <ul>
                <li><b>הרעיון: Dana Arnon Perry</b> -מלמדת אוריינות נתונים, קוסמת של אינסייטים ומי שאחראית לכך שפסח השנה קיבל גרסת BI 😎</li>
                <li><b>המוציא לפועל: ChatGPT</b> - רובוט צייתן עם חוש הומור בריא ואובססיה לדאטה סטים מוזרים מתקופת המקרא</li>
                <li><b>דאטה סטוריטלר: Claude</b> - דאטה סטוריטלר: Claude – אחראי על שדרוג הקוד והמראה של הדשבורד ותכל'ס הייתי צריך לעשות את רוב העבודה בסוף (רק אומר).</li>
            </ul>
        </div>
        """, unsafe_allow_html=True)
